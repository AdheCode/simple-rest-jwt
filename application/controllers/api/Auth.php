...
class Auth extends BD_Controller {
    ...
    public function login_post()
    {
        ...
        if($this->M_main->get_user($q)->num_rows() == 0){$this->response($invalidLogin, REST_Controller_Definitions::HTTP_NOT_FOUND);}
        ...
        if($p == $match){  //Condition if password matched
            ...
            $this->set_response($output, REST_Controller_Definitions::HTTP_OK); //This is the respon if success
        }
        else {
            $this->set_response($invalidLogin, REST_Controller_Definitions::HTTP_NOT_FOUND); //This is the respon if failed
        }
    }
